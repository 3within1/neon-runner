...
export const practiceBtn = document.getElementById("practice-btn");
export const hardToggleBtn = document.getElementById("hard-toggle");
...
export const metaRowEl = document.getElementById("meta-row");
